    ...
    <>
      ...
      <div className=" xl:flex m-2 p-2">
        ...
        <div className="flex items-center m-4 justify-around ">
          ...
          <button
            className="bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 ml-4 border-b-4 border-red-700 hover:border-red-500 rounded align-middle"
            onClick={resetPlate}
          >
            Reset Plate
          </button>
       ...
       <div className="flex justify-end">
        <button
          ...
          className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded align-middle"
        >
          Export to Excel
        </button>
      </div>
